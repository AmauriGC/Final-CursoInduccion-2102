...
public class GmailSender {
    ...
    public GmailSender() throws Exception {
        ...
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory))
                .setApplicationName("Cursos Induccion")
                .build();
    }
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory,
                new InputStreamReader(GmailSender.class.getResourceAsStream("/META-INF/credentials.json")));
    ...
    public static void main(String[] args) throws Exception {
        new GmailSender().sendMail(
                "20233tn102@utez.edu.mx",
                "Nuevo mensaje",
                "<h1>" +
                        "Montes Patiño Oscar Uriel, \n " +
                        "Gonzaga Castañeda Cristian Amauri, \n  " +
                        "Ortuño Rogel Angel Gustavo, \n  " +
                        "Mijangos Beltran Leonardo Daniel, \n  " +
                        "Cervantesz Hernadez Jose Guadalupe" +
                        "</h1>");
    }
}